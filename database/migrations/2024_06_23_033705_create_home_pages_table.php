...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('home_pages', function (Blueprint $table) {
            ...
            $table->text('row_seven_header')->nullable();

            $table->foreignId('row_seven_course_one')->nullable()->constrained('courses')->onDelete('cascade');
            $table->foreignId('row_seven_course_two')->nullable()->constrained('courses')->onDelete('cascade');
            $table->foreignId('row_seven_course_three')->nullable()->constrained('courses')->onDelete('cascade');
