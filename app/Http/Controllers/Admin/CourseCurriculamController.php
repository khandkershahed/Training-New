...
class CourseCurriculamController extends Controller
{
    ...
    //     $fileNamePdf = hexdec(uniqid()) . '.' . $file->getClientOriginalExtension();
    //     $destinationPath = 'content/files/';
    //     $file->storeAs($destinationPath, $fileNamePdf, 'public');
    //     $filePath = $destinationPath . $fileNamePdf;
    //     //File End
    ...
    //         CourseCurriculumContent::insert([
    ...
    //     // Validate the request
    //     $request->validate([
    //         'course_file' => 'nullable|file|mimes:pdf,doc,docx|max:2048', // 2 MB
