        ...
        <div class="col-xl-4">
            ...
            <div class="card card-xl-stretch">
                ...
                <div class="card-header border-0 bg-danger py-5">
                    <h3 class="card-title fw-bolder text-white">{{ __('Dashboard Summary') }} </h3>
                    ...
                    <div class="card-p mt-n20 position-relative">
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                                ...
                                <!--end::Svg Icon-->
                                <a href="{{ route('admin.course.index') }}" class="text-warning fw-bold fs-6">Total
                                    Course</a>
                            </div>
                            <!--end::Col-->
                            <!--begin::Col-->
                            <div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">
                                ...
                                <a href="{{ route('admin.all.registration') }}"
                                    class="text-primary fw-bold fs-6">Register Course</a>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Row-->
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col bg-light-danger px-6 py-8 rounded-2 me-7">
                                ...
                                <a href="{{ route('admin.admin-management.index') }}"
                                    class="text-danger fw-bold fs-6 mt-2">Total Employee</a>
                            </div>
                            <!--end::Col-->
                            <!--begin::Col-->
                            <div class="col bg-light-success px-6 py-8 rounded-2">
                                ...
                                <a href="{{ route('admin.user-management.index') }}"
                                    class="text-success fw-bold fs-6 mt-2">Total User</a>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Row-->
