<x-admin-app-layout :title="'Course Section Update'">
    <div class="card card-flash">
        ...
        <div class="card-body">
            ...
            <form id="myForm" method="post" action="{{ route('admin.course_section.update', $item->id) }}"
                    ...
                    <div class="row p-4">
                        ...
                        <div class="col-4 mb-3">
                            <div class="form-group">
                                ...
                                <img class="mt-3" src="{{ asset('storage/course_section/' . $item->banner_image) }}"
                        ...
                        <div class="col-4 mb-3">
                            <div class="">
                                ...
                                <img class="mt-3" src="{{ asset('storage/course_section/' . $item->thumbnail_image) }}"
                                    height="60" width="60" alt="">
                            </div>
                        </div>
                        ...
                        <div class="col-4 mb-3">
                            <div class="">
                                ...
                                <img class="mt-3" src="{{ asset('storage/course_section/' . $item->logo) }}"
                                    height="60" width="60" alt="">
                            </div>
                        </div>
