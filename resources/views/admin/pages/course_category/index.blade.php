<x-admin-app-layout :title="'Course Category'">
    ...
    <div class="card card-flash">
        <div class="card-header mt-6">
            ...
            <div class="card-toolbar">
                <a href="{{ route('admin.course_category.create') }}" class="btn btn-light-primary rounded-2">
                ...
                <tbody class="fw-bold text-gray-600">
                    ...
                    @foreach ($courseCats as $key => $courseCat)
                        <tr>
                            ...
                            <td class="text-start">{{ $courseCat->section->name }}</td>
