<x-admin-app-layout :title="'Coupon Edit'">
    <div class="card card-flash">
        ...
        <div class="card-body">
            ...
            <form id="myForm" method="post" action="{{ route('admin.coupon.update',$coupon->id) }}"
                        ...
                        <div class="col-4 mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="coupon_name" placeholder="Coupon Name"
                                    class="form-control form-control-sm" value="{{ $coupon->coupon_name }}">
                            </div>
                        </div>
                        ...
                        <div class="col-2 mb-3">
                            <div class="form-group">
                                ...
                                <input type="number" name="coupon_discount" placeholder="Eg: 20%"
                                    class="form-control form-control-sm" value="{{ $coupon->coupon_discount }}">
                            </div>
                        </div>
