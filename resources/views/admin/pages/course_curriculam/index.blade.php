<x-admin-app-layout :title="'Course Curriculam List'">
    ...
    <div class="card card-flash">
        <div class="card-header mt-6">
            ...
            <div class="card-toolbar">
                <a href="{{ route('admin.course_curriculam.create') }}" class="btn btn-light-primary rounded-2">
                ...
                <tbody class="fw-bold text-gray-600">
                    ...
                    @foreach ($courseCurriculams as $key => $courseCurriculam)
                        <tr>
                            ...
                            <td class="text-start">{{ $courseCurriculam->course->name }}</td>
                            <td class="text-start">{{ $courseCurriculam->badge }}</td>
                            <td class="text-start">{{ $courseCurriculam->title }}</td>
