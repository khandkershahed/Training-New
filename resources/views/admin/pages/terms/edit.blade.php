<x-admin-app-layout :title="'Terms And Condition Update'">
    <div class="card card-flash">
        ...
        <div class="card-body">
            ...
            <form id="myForm" method="post" action="{{ route('admin.terms-and-condition.update', $term->id) }}"
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="content" rows="3" cols="3"
                                    class="editor form-control @error('content') is-invalid @enderror">{!! $term->content !!}</textarea>
                                @error('content')
                                    <span class="text-danger"> {{ $message }} </span>
                                @enderror
                            </div>
                        ...
                        <div class="col-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="date" name="effective_date"
                                    ...
                                    placeholder="Question" value="{{ $term->effective_date }}"
