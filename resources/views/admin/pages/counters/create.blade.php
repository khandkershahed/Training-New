<x-admin-app-layout :title="'Counter Add'">
    <div class="card card-flash">
        ...
        <div class="card-body pt-0">
            <!--begin::Form-->
            <form class="form" action="{{ route('admin.counters.store') }}" method="POST">
                @csrf
                <!--begin::Input group-->
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-7">
                        ...
                        <x-metronic.input id="number" type="number" name="number" :value="old('number')"
