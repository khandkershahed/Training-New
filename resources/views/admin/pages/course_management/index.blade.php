    ...
    <div class="card card-flash">
        <div class="card-header mt-6">
            ...
            <div class="card-toolbar">
                <a href="{{ route('admin.course_management.create') }}" class="btn btn-light-primary rounded-2">
                    ...
                    @foreach ($items as $key => $item)
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <img class=""
                                    src="{{ !empty($item->image) ? url('storage/course_mgt/' . $item->image) : 'https://ui-avatars.com/api/?name=' . urlencode($item->name) }}"
