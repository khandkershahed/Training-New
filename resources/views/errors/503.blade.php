<x-admin-guest-layout :title="'503 Error'">
        ...
        <div class="row fullscreen-bg px-0">
            <div class="col-lg-12 content">
                ...
                <div>
                    ...
                    <h3 class="pt-5">Our service is currently unavailable. We are working on resolving the issue.
        ...
        <div class="row">
            <div class="col-lg-12 content-bottom">
                <div class="error-footer">
                    <div>
                        <h1 class="card-title">We’re On It!</h1>
