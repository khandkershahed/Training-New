<x-admin-guest-layout :title="'419 Error'">
        ...
        <div class="row fullscreen-bg px-0">
            <div class="col-lg-12 content">
                ...
                <div>
                    ...
                    <h3 class="pt-5">Your session has expired. Please refresh the page and try again.</h3>
                </div>
                <div class="mt-5 pt-5">
                    <a href="{{ route('homepage') }}" class="primary-btn-one">
                        Back to Home <i class="fa-solid fa-long-arrow-right"></i>
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12 content-bottom">
                <div class="error-footer">
                    <div>
                        <h1 class="card-title">Need More Help?</h1>
                        <h3 class="pt-2 mb-5">If you continue to experience issues, please contact our support team for
                            assistance.</h3>
                    </div>
