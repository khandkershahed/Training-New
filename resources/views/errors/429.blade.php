<x-admin-guest-layout :title="'429 Error'">
        ...
        <div class="row fullscreen-bg px-0">
            <div class="col-lg-12 content">
                ...
                <div>
                    ...
                    <h3 class="pt-5">You have made too many requests in a short period of time. Please try again
                        later.</h3>
                </div>
                <div class="mt-5 pt-5">
            ...
            <div class="col-lg-12 content-bottom">
                <div class="error-footer">
                    <div>
                        ...
                        <h3 class="pt-2 mb-5">If you need help or have questions about our service, please contact our
                            support team.</h3>
                    </div>
