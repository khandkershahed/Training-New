<x-admin-guest-layout :title="'402 Error'">
        ...
        <div class="row fullscreen-bg px-0">
            <div class="col-lg-12 content">
                ...
                <div>
                    ...
                    <h3 class="pt-5">This action requires payment. Please ensure your subscription is active.</h3>
                </div>
                <div class="mt-5 pt-5">
                    <a href="{{ route('billing') }}" class="primary-btn-one">
                        Manage Billing <i class="fa-solid fa-long-arrow-right"></i>
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-12 content-bottom">
                <div class="error-footer">
                    <div>
                        ...
                        <h3 class="pt-2 mb-5">If you have any questions about your payment or subscription, please
                            contact our support team.</h3>
                    </div>
