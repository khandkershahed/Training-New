        ...
        <div class="row g-5 gx-xl-10 mb-5 mb-xl-10">
            ...
            @foreach ($events as $event)
                <div class="col-lg-3 col-md-6">
                    <div class="card bg-info h-xl-100">
                        <div class="card-header">
                            <h3 class="card-title fw-semibold text-center text-white">{{ $event->eventName->event_name }} </h3>
                        </div>
                        <div class="card-body d-flex flex-column pt-13 pb-14">
                            ...
                            <div class="text-center">
                                {{-- <a class="btn btn-sm btn-success btn-color-white me-2">
                                    Support </a> --}}
                                <a class="btn btn-sm bg-white btn-color-white text-black" href="{{ route('user.event.details',$event->eventName->slug) }}">
                                    Details </a>
                            </div>
                        </div>
                    </div>
